        ...
        implements Closeable
{
    ...
    private final boolean securedController;

    public TestingPinotCluster(Network network, boolean securedController, boolean securedBroker)
    {
        ...
        String controllerConfig = securedController ? "/var/pinot/controller/config/pinot-controller-secured.conf" : "/var/pinot/controller/config/pinot-controller.conf";
        ...
        String brokerConfig = securedBroker ? "/var/pinot/broker/config/pinot-broker-secured.conf" : "/var/pinot/broker/config/pinot-broker.conf";
            ...
            throws Exception
    {
        ...
        Request request = Request.Builder.preparePost()
                ...
                .addHeader(HttpHeaders.AUTHORIZATION, securedController ? controllerAuthToken() : "")
    ...
    private static String controllerAuthToken()
    {
        ...
        byte[] encodedAuth = Base64.getEncoder().encode("admin:verysecret".getBytes(StandardCharsets.ISO_8859_1));
